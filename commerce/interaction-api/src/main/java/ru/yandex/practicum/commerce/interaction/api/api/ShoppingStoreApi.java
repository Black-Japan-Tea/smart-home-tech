...
public interface ShoppingStoreApi {
    ...
    String API_PATH = "/api/v1/shopping-store";

    @GetMapping
    PageResponse<ProductDto> getProducts(@RequestParam("category") ProductCategory category,
    ...
    boolean setProductQuantityState(
            ...
            @Valid @RequestBody(required = false) ru.yandex.practicum.commerce.interaction.api.dto.SetProductQuantityStateRequest request);
